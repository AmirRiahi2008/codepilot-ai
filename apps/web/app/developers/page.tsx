...
return ( <main className="min-h-screen bg-[#050505] text-white px-6 py-20"> <div className="mx-auto max-w-5xl"> <Link
       href="/"
...
← Back </Link>
    ...
    <div className="mt-16 grid gap-12 md:grid-cols-[280px_1fr] items-start">
      <div>
